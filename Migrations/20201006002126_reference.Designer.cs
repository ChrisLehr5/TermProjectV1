...
namespace TermProjectV1.Migrations
{
    ...
    [Migration("20201006002126_reference")]
            ...
            modelBuilder.Entity("TermProjectV1.Models.Details", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MemberID = 1,
                            age = 34,
                            detailDate = new DateTime(2020, 10, 5, 20, 21, 26, 131, DateTimeKind.Local)
                        },
                        new
                        {
                            ID = 2,
                            MemberID = 2,
                            age = 31,
                            detailDate = new DateTime(2020, 10, 5, 20, 21, 26, 134, DateTimeKind.Local).AddTicks(2)
                        },
                        new
                        {
                            ID = 3,
